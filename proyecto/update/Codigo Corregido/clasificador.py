...
class AnalizadorSentimiento(AnalizadorBase):
    ...
    def __cargar_lexicon(self):
        ...
        return {
            ...
            "siempre": 0.3,
            # ── VARIANTES DE FLEXIÓN E INSULTOS FALTANTES (datos reales X) ──
            # Variantes de género/número de términos ya ponderados e insultos
            # frecuentes ausentes, detectados al validar con comentarios reales.
            "maldita": -3,       "corrupta": -3,       "corruptos": -3,
            "corruptas": -3,     "mafiosa": -3,        "mafiosos": -3,
            "ladrona": -3,       "asesina": -3,        "criminales": -3,
            "delincuentes": -3,  "idiotas": -3,        "estupida": -3,
            "enfermos": -2,      "enferma": -2,        "inutiles": -2,
            "ineptos": -2,       "miserables": -3,     "asquerosa": -2,
            "mentirosa": -2,     "mentiroso": -2,      "pendejos": -2,
            "traidor": -2,       "traidora": -2,       "traidores": -2,
            "pervertido": -3,    "pervertida": -3,     "odiador": -2,
            "odiadora": -2,      "rata": -2,           "ratas": -2,
            "payaso": -2,        "tarado": -3,         "tarada": -3,
            "subnormal": -3,     "malparido": -3,      "careverga": -3,
            "asqueroso": -2,     "degenerada": -3,     "degenerado": -3,
            "onanista": -2,      "vaga": -2,           "sirviente": -2,
            "lobbista": -2,      "largate": -2,        "lárgate": -2,
            "vete": -2,          "cagada": -2,         "mrda": -3,
            "kchudo": -3,        "hdrmp": -3,          "cdtm": -3,
            "zdm": -3,           "rcsm": -3,
            # ── JERGA PERUANA E INSULTOS DE OPINIÓN (validados con datos reales) ──
            # Términos despectivos frecuentes en comentarios políticos peruanos
            # que un léxico genérico no captura y dejaban frases hostiles en neutro.
            "descaro": -2,       "caradura": -2,       "cínico": -2,
            "cinico": -2,        "patético": -3,       "patetico": -3,
            "patetica": -3,      "cobarde": -2,        "cobardes": -2,
            "mediocre": -2,      "mediocres": -2,      "incapaz": -2,
            "vendido": -2,       "vendida": -2,        "vendidos": -2,
            "arrastrado": -2,    "lacayo": -2,         "lameculos": -3,
            "chupamedias": -2,   "sapo": -2,           "ratero": -2,
            "rateros": -2,       "jeropa": -2,         "jeropas": -2,
            "chancho": -2,       "cerdo": -2,          "piraña": -2,
            "pirañas": -2,       "presipiraña": -3,    "huevón": -2,
            "huevon": -2,        "conchudo": -2,       "conchuda": -2,
            "fujirata": -3,      "fujiratas": -3,      "terruco": -2,
            "terrucos": -2,
            # "vacaron"/"vacar" dirigido a una persona se usa de forma hostil
            # ("te vacaron", "qué bueno que te vacaron"). Se excluye el sustantivo
            # "vacancia", que aparece en descripciones neutrales del proceso.
            "vacaron": -3,       "vacado": -3,         "vacada": -3,
            "vacarte": -3,       "vacar": -3,
            # ── AJUSTES PUNTUALES (revisión manual de clasificaciones) ──
            "pendejada": -2,     "tmre": -3,           "osciosa": -2,
            "ociosa": -2,        "ocioso": -2,
            "disfruta": 2,       "disfruten": 2,       "disfrute": 2,
            "disfrutar": 2,      "disfrutalo": 2,
            # insultos/expresiones (segunda revisión manual)
            "pvta": -3,          "tmr": -3,            "huye": -2,
            "ajena": -1,         "ajeno": -1,
            # "acuerdo" captura la expresión compuesta "de acuerdo" (acuerdo/apoyo)
            "merecido": 2,       "acuerdo": 2,
            "muertos": -2,       "muertes": -2,
            # "violín" se usa como apodo-insulto (no como instrumento) en este corpus
            "violin": -3,        "violín": -3,         "violines": -3,
            "violinista": -3, "vio lin": -3,
 }
